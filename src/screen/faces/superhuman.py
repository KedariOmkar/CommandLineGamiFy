    ...
    try:
        ...
        if select == 1:
            ...
            if common_functions.select_option == 1:
                common_functions.update_db('skill_sh', 'mission_learn', 'time_learn', 'atma', 'report_time_learn', 'report_mission_learn')
            if common_functions.select_option == 2:
                common_functions.update_db('skill_sh', 'mission_recall', 'time_recall', 'atma', 'report_time_recall', 'report_mission_recall')
            if common_functions.select_option == 3:
                common_functions.update_db('skill_sh', 'mission_test', 'time_test', 'atma', 'report_time_test', 'report_mission_test')
        ...
        if select == 2:
            ...
            common_functions.accept_skill()
            if common_functions.select_option == 1:
                common_functions.update_db('skill_sh', 'mission_learn', 'time_learn', 'brain', 'report_time_learn',
                                           'report_mission_learn')
            if common_functions.select_option == 2:
                common_functions.update_db('skill_sh', 'mission_recall', 'time_recall', 'brain', 'report_time_recall',
                                           'report_mission_recall')
            if common_functions.select_option == 3:
                common_functions.update_db('skill_sh', 'mission_test', 'time_test', 'brain', 'report_time_test',
                                           'report_mission_test')
            common_functions.money_earned()
            common_functions.refresh_update()
        ...
        if select == 3:
            ...
            common_functions.accept_skill()
            if common_functions.select_option == 1:
                common_functions.update_db('skill_sh', 'mission_learn', 'time_learn', 'body', 'report_time_learn',
                                           'report_mission_learn')
            if common_functions.select_option == 2:
                common_functions.update_db('skill_sh', 'mission_recall', 'time_recall', 'body', 'report_time_recall',
                                           'report_mission_recall')
            if common_functions.select_option == 3:
                common_functions.update_db('skill_sh', 'mission_test', 'time_test', 'body', 'report_time_test',
                                           'report_mission_test')
            common_functions.money_earned()
            common_functions.refresh_update()

...
while True:
    ...
    if option == 0:
        ...
        if option == 2:
            ...
            def stats():
                ...
                def plot_mission_line(report_table):
                    ...
                    plt.plot(
                        fetch_dates(),
                        fetch_data_points("total_mission", "report_mission_learn"),
                        color="blue",
                        linestyle="-",
                        marker="o",
                        label="Learn",
                    ...
                    plt.plot(
                        fetch_dates(),
                        fetch_data_points("total_mission", "report_mission_recall"),
                        color="red",
                        linestyle="-",
                        marker="o",
                        label="Recall",
                    ...
                    plt.plot(
                        fetch_dates(),
                        fetch_data_points("total_mission", "report_mission_test"),
                        color="green",
                        linestyle="-",
                        marker="o",
                        label="Test",
                ...
                def plot_time_line(report_table):
                    ...
                    plt.plot(
                        fetch_dates(),
                        fetch_data_points("total_time", "report_time_learn"),
                        color="blue",
                        linestyle="-",
                        marker="o",
                        label="Learn",
                    ...
                    plt.plot(
                        fetch_dates(),
                        fetch_data_points("total_time", "report_time_recall"),
                        color="red",
                        linestyle="-",
                        marker="o",
                        label="Recall",
                    ...
                    plt.plot(
                        fetch_dates(),
                        fetch_data_points("total_time", "report_time_test"),
                        color="green",
                        linestyle="-",
                        marker="o",
                        label="Test",
                ...
                def plot_grp_time(skill_table, field, title):
                    ...
                    plt.xticks(
                        [r + bar_width for r in range(len(learn_list))], name_list
                    )
                ...
                def CompetitionMoneyEarned():
                    ...
                    fetch_points_competition = (
                        "select total_money from game_competition"
                    )
                ...
                while True:
                    ...
                    print("\t\t::: TIME :::")
                    print(
                        "\t\t\t 1[ LEARN ]    2[ RECALL ]    3[ TEST ]    111[ COMBINE ]"
                    )
                    print("\t\t::: MISSION  :::")
                    print(
                        "\t\t\t 4[ LEARN ]    5[ RECALL ]    6[ TEST ]    222[ COMBINE ]"
                    )
                    print("\t\t::: MONEY :::")
                    print("\t\t\t 7[ T EARNED ]   8[ T COMP EARNED ]  9[ WAR ]")
                    print("\t:::: CHARACTER :-")
                    print(
                        "\t\t\t 11[ T ROUTINE ]  444[ C ROUTINE ]  22[ T AGENTS ]  333[ C AGENTS]   "
                    )
                    print("\t:::: Pillar Reports :-")
                    print(
                        "\t\t\t TW : 1[ LANG ]   2[ DSA ]   3[ SUB ]   4[ TECH ]   5[ TOOLS ]   6[ BUILD ]"
                    )
                    ...
                    if view == "g":
                        ...
                        if mission_or_time == 0:
                            graph = int(input("\t! Graph ID: "))
                            plot_grp_time(
                                table_list.get(graph),
                                field_list.get(graph),
                                title_list.get(graph),
                            )
        ...
        if option == 3:
            process = subprocess.Popen(['streamlit', 'run', 'statistics.py'])
            time.sleep(3)
